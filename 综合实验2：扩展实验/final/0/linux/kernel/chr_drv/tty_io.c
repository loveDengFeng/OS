...
int mouse_x_position=50;
int mouse_y_position=50;
...
void readmouse(int mousecode)
{
	...
	switch(mouse_input_count){
		case 1:
			...
			mouse_right_move=(mousecode&0x20)==0x20;
			mouse_input_count++;
			break;
		case 2:
		    if(mouse_left_move){
			...
			if(mouse_x_position>200) mouse_x_position=200;
		...
		case 3:
			...
			if(mouse_x_position>200) mouse_y_position=200;
