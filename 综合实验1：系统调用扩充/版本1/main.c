...
__always_inline _syscall0(void,execve2)
__always_inline _syscall0(void,getdents)
__always_inline _syscall0(void,sleep)
__always_inline _syscall0(void,getcwd)
